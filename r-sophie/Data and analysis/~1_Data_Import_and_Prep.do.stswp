clear all
	...
	gl FolderDirect `c(pwd)'	// Path of the folder "Replication_Conflict"
	gl out `wd'\out				// Path of output folder
...
save partial_with_indep_obs, replace
...
save partial_with_conflict, replace
...
save partial_with_rel_arming, replace
...
save partial_with_arm_def_att, replace
...
save partial_unarmed_block, replace
...
save partial_questionnaire_block, replace
