...
conflict_replication1 <- read_dta("D:/Users/B435076/Documents/GitHub/Trab-sophie/r-sophie/Data and analysis/conflict_replication1.dta")
...
reg_out_cont <- c("arming", "arm_def", "arm_att") 
